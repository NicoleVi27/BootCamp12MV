...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'postgres',
        'USER': os.getenv("database_USER"),           #ADD despliegue VERCEL
        'PASSWORD': os.getenv("database_PASSWORD"),   #ADD despliegue VERCEL
        'HOST': os.getenv("database_HOST"),  #ADD despliegue VERCEL
        'PORT': '6543',
        "OPTIONS" : {
            "sslmode": "verify-full",
